...
# Generated by qmake (2.01a) (Qt 4.7.1) on: ?? 4? 14 14:20:20 2024
# Project:  lpl.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lpl1.0.0/ && $(COPY_FILE) --parents dlinklist.h qt1.h dlinklist.c .tmp/lpl1.0.0/ && $(COPY_FILE) --parents main.cpp qt1.cpp camera.cpp .tmp/lpl1.0.0/ && $(COPY_FILE) --parents qt1.ui .tmp/lpl1.0.0/ && (cd `dirname .tmp/lpl1.0.0` && $(TAR) lpl1.0.0.tar lpl1.0.0 && $(COMPRESS) lpl1.0.0.tar) && $(MOVE) `dirname .tmp/lpl1.0.0`/lpl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lpl1.0.0
