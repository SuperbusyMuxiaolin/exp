...
# Generated by qmake (2.01a) (Qt 4.7.1) on: ?? 4? 14 22:15:17 2024
# Project:  lpl.pro
# Template: app
...
$(TARGET): ui_qt1.h ui_historyr.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lpl1.0.0/ && $(COPY_FILE) --parents dlinklist.h qt1.h dlinklist.c historyr.h .tmp/lpl1.0.0/ && $(COPY_FILE) --parents main.cpp qt1.cpp camera.cpp historyr.cpp .tmp/lpl1.0.0/ && $(COPY_FILE) --parents qt1.ui historyr.ui .tmp/lpl1.0.0/ && (cd `dirname .tmp/lpl1.0.0` && $(TAR) lpl1.0.0.tar lpl1.0.0 && $(COMPRESS) lpl1.0.0.tar) && $(MOVE) `dirname .tmp/lpl1.0.0`/lpl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lpl1.0.0
...
compiler_moc_header_make_all: moc_qt1.cpp moc_historyr.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qt1.cpp moc_historyr.cpp
...
compiler_uic_make_all: ui_qt1.h ui_historyr.h
compiler_uic_clean:
	-$(DEL_FILE) ui_qt1.h ui_historyr.h
ui_qt1.h: qt1.ui
